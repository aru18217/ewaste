              ...
              <div class="card card-warning">
                ...
                <div class='form'><form name="cal" method='post' action='simpan_antar.php' class='cmxform form-horizontal tasi-form' id='commentForm'>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">Nama<h7 class="text-danger">*</h7></label>
                      <div class="col-lg-10">
                      <input type="text" name="nama" class="form-control" id="exampleInputName1" placeholder="Masukkan Nama"  value="<?=isset($_POST['nama']) ? $_POST['nama'] : ''?>" required>                    
                      </div>                      
                    </div>
                      <div class='form-group'>
                        <label for='cname'>Wilayah  <h7 class="text-danger">*</h7></label>
                        <div class="col-lg-10">
                          <select name="wilayah" id="wilayah" onchange="myFunction(event)" class='form-control' required> 
                    ...
                    <div class="form-group">
                      <label for="exampleInputNumber1">Alamat Toko<h7 class="text-danger">*</h7></label>
                      <div class="col-lg-10">
                      <input type="text" name="alamat" class="form-control" id="exampleInputNumber1" placeholder="Masukkan alamat lengkap toko" value="<?=isset($_POST['alamat']) ? $_POST['alamat'] : ''?>" required>                  
                      </div>                      
                    </div>
                    ...
                    ?>
                    <div class='form-group'>
                      <label for='cname'>Tanggal Penjemputan<h7 class="text-danger">*</h7></label>
                      <div  class='control-label col-lg-5'>
                      <input type='date' value="<?php echo $tgl ?>" class='form-control' name='tgl_transaksi' id="demo" required>                   
                      </div>                        
                      </div>
                    <div class="col-sm-10">
                      <div class='form-group'>
                        <label for='cname'>Jenis Sampah<h7 class="text-danger">*</h7></label>
                        <div>
                      ...
                      <div class='form-group'>
                        <label for='cname' class='control-label col-lg-10'>Total Bayar <h7 class="text-danger">*</h7></label>
                        <div class='col-lg-10'>
                          <input id="total_bayar" name="total_bayar"  class='form-control' type="number" value="0" readonly="readonly">          
                        </div>
                      </div>
                      <div class='form-group'>
                    <div class="col-sm-10">
